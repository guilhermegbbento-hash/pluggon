...
export const DISCARD_REASON_LABELS: Record<DiscardReason, string> = {
  ...
  shopping_sem_porte: "shopping sem porte (galeria ou sala comercial)",
  posto_sem_porte: "posto sem porte (registro fantasma)",
  ancora_abaixo_do_corte: "âncora abaixo da nota de corte",
  ancora_abaixo_do_corte_renda_baixa: "âncora abaixo da nota de corte em região de renda baixa",
